...
import com.ashlikun.zxing.simple.databinding.ActivityMain0Binding
...
class ScanActivity0 : AppCompatActivity() {
    val binding by lazy {
        ActivityMain0Binding.inflate(layoutInflater)
    }
...
//                .commit();
    ...
    companion object {
        fun startSelf(context: Context) {
            context.startActivity(Intent(context, ScanActivity0::class.java))
        }
    }
