...
class AbleManager private constructor(handler: Handler) : com.ashlikun.zxing.able.PixsValuesAble(handler) {
    ...
    fun loadAbility() {
        ableList.clear()
        ableList.apply {
            add(com.ashlikun.zxing.able.XQRScanCrudeAble(handlerHolder.get()))
            if (Config.isSupportAutoZoom)
                add(com.ashlikun.zxing.able.XQRScanZoomAble(handlerHolder.get()))
            else add(com.ashlikun.zxing.able.XQRScanAble(handlerHolder.get()))
            add(com.ashlikun.zxing.able.XQRScanAbleRotate(handlerHolder.get()))
            add(com.ashlikun.zxing.able.LighSolveAble(handlerHolder.get()))
        }
