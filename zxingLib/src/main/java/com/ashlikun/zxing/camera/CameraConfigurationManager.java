...
final class CameraConfigurationManager {
     ...
     */
    void initFromCameraParameters(int width, int height, Camera camera) {
        this.width = width;
        this.height = height;
    ...
    private static Point getCameraResolution(Camera.Parameters parameters, int width, int height) {
        Point screenResolution = new Point();
        screenResolution.x = width;
        screenResolution.y = height;
        if (width < height) {
            screenResolution.x = height;
            screenResolution.y = width;
        }
