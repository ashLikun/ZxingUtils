...
package com.ashlikun.zxing.luminance;

import com.google.zxing.LuminanceSource;

/**
 * @author　　: 李坤
 * 创建时间: 2019/3/15 17:06
 * 邮箱　　：496546144@qq.com
 * <p>
 * 功能介绍：图片灰色化
 */

public final class RGBHuiLuminanceSource extends LuminanceSource {
    ...
    public RGBHuiLuminanceSource(int width, int height, int[] pixels) {
        super(width, height);
    ...
    private RGBHuiLuminanceSource(byte[] pixels,
                                  int dataWidth,
                                  int dataHeight,
                                  int left,
                                  int top,
    ...
    public LuminanceSource crop(int left, int top, int width, int height) {
        return new RGBHuiLuminanceSource(luminances,
                dataWidth,
                dataHeight,
                this.left + left,
                this.top + top,
